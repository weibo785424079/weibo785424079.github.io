...
var build = function (options) { return __awaiter(void 0, void 0, void 0, function () {
    var entry, watch, _a, external, _b, replaceOpts, type, cwd, rollupConfig, _loop_1, _i, rollupConfig_1, config;
        ...
        switch (_c.label) {
            case 0:
                ...
                rollupConfig = getConfig_1.default({
                    entry: entry, cwd: cwd, type: type, replaceOpts: replaceOpts, external: external,
                });
